...
* **미리보기 섬네일 및 비추천수 표시**: 본 설정은 디시인사이드 서버의 Rate Limit이 변경되며 정상적인 기능이 불가능해짐에 따라 더 이상 사용을 권장하지 않습니다.
* **이용자 메모**: ~~모바일 웹에서도 지원~~ [공지사항](https://m.dcinside.com/board/know/428)을 참고하세요.
